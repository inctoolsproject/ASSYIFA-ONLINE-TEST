<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <a href="<?= base_url('dosen/add') ?>" class="btn btn-sm bg-purple btn-flat"><i class="fa fa-plus"></i>
                Tambah Data</a>
            <button type="button" onclick="reload_ajax()" class="btn btn-sm btn-default btn-flat"><i
